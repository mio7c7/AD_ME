...
parser.add_argument('--bs', type=int, default=100, help='buffer size for ssa')
...
parser.add_argument('--outfile', type=str, default='vae50_51_3_975_10', help='name of file to save results')
