...
parser.add_argument('--update', type=int, default=50, help='memory size per distribution ')
...
parser.add_argument('--outfile', type=str, default='2_std_05', help='name of file to save results')
...
if __name__ == '__main__':
    ...
    for i in glob.glob(folder):
        ...
        while ctr < test_var_dl.shape[0]:
            ...
            if collection_period > args.memory_size:
                ...
                if collection_period + len(window) < args.memory_size:
                    ...
                    if detector.current_index == -1: # new cluster
                        ...
                        feature_extracter.fit(train, batch_size=args.batch_size, epochs=args.epoch, validation_data=(valid, valid),
            ...
            if len(detector.newsample) >= args.update:
