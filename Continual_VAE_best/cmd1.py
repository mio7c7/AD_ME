...
commands = [
    ...
    "python Continual_VAE_best/main_qsl2.py --data './data3/*.npz' --bs 150 --ws 100 --min_requirement 200 --memory_size 400 --cp_range 5 --forgetting_factor 0.55 --out_threshold 2 --threshold 4 --quantile 0.95 --outfile 'bestqsl2_w100'",
    "python Continual_VAE_best/main_qsl2.py --data './data3/*.npz' --bs 200 --ws 150 --min_requirement 200 --memory_size 400 --cp_range 5 --forgetting_factor 0.55 --out_threshold 2 --threshold 4 --quantile 0.95 --outfile 'bestqsl2_w150'",
    "python Continual_VAE_best/main_qsl2.py --data './data3/*.npz' --bs 125 --ws 75 --min_requirement 200 --memory_size 400 --cp_range 5 --forgetting_factor 0.55 --out_threshold 2 --threshold 4 --quantile 0.95 --outfile 'bestqsl2_w75'",
    "python Continual_VAE_best/main_qsl2.py --data './data3/*.npz' --bs 100 --ws 50 --min_requirement 200 --memory_size 400 --cp_range 5 --forgetting_factor 0.55 --out_threshold 2 --threshold 4 --quantile 0.95 --outfile 'bestqsl2_w50'",
]
