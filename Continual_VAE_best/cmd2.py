...
commands = [
    "python Continual_VAE_best/main.py --data './data3/*.npz' --bs 48 --ws 40 --memory_size 200 --dense_dim 2 --dropout 0.5 --kl_weight 1 --epoch 100 --out_threshold 2 --threshold 5 --quantile 0.9 --outfile 'bestsqt_1'",
    "python Continual_VAE_best/main.py --data './data3/*.npz' --bs 48 --ws 40 --memory_size 200 --dense_dim 2 --dropout 0.5 --kl_weight 1 --epoch 100 --out_threshold 2 --threshold 5 --quantile 0.92 --outfile 'bestsqt_2'",
