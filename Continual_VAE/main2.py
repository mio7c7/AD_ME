...
parser.add_argument('--ws', type=int, default=20, help='window size')
...
parser.add_argument('--outfile', type=str, default='main2_1', help='name of file to save results')
...
if __name__ == '__main__':
    ...
    for i in glob.glob(folder):
        ...
        feature_extracter = VAE(args.ws, 1, args.dense_dim, 'relu', args.latent_dim, args.kl_weight)
