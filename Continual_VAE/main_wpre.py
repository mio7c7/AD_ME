...
if __name__ == '__main__':
    ...
    for i in glob.glob(folder):
        ...
        feature_extracter.fit(noisy_Data, batch_size=8, epochs=args.epoch, validation_split=0.2, shuffle=True, callbacks=[es])
        ...
        while ctr < test_var_dl.shape[0]:
            ...
            for k in range(len(new)):
                ...
                if collection_period < args.collection_period:
                    ...
                    feature_extracter.fit(noisy_Data, batch_size=8, epochs=50, validation_split=0.2,
